...
def _router_page(posts_ar: list[dict], posts_en: list[dict]) -> str:
    ...
    schema = json.dumps({"@context":"https://schema.org","@graph":[{"@type":"WebSite","name":"RDWAN Tech","url":SITE+"/forum/","inLanguage":["ar","en"]},{"@type":"NewsMediaOrganization","name":"RDWAN Tech","url":SITE+"/forum/","founder":{"@type":"Person","name":"Radwan Abdulhadi","url":SITE+"/"}}]}, ensure_ascii=False, separators=(",",":"))
