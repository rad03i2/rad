...
def render_record(record: dict, locale: str = "ar") -> str:
    ...
    return template.substitute(
        ...
        NAV_SECTIONS_TEXT=_e("الأقسام" if locale == "ar" else "Sections"),
        NAV_TOP_TEXT=_e("الأهم الآن" if locale == "ar" else "Top stories"),
        NAV_NEWSLETTER_TEXT=_e("النشرة" if locale == "ar" else "Newsletter"),
        ...
        NAV_SECTIONS_URL=_ea(f"/forum/{locale}/#sections"),
        NAV_TOP_URL=_ea(f"/forum/{locale}/#top-stories"),
        NAV_NEWSLETTER_URL=_ea(f"/forum/{locale}/#newsletter"),
