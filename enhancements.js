(() => {
  ...
  function addProcess() {
    ...
    const items = lang==='ar' ? [['01','الفكرة','تحدد الهدف والنتيجة التي تريد الوصول إليها.'],['02','إرسال الطلب','تعبئ نموذج Tally بتفاصيل المشروع والميزانية والملفات إن وجدت.'],['03','الاستشارة','عند الحاجة تحجز جلسة Calendly لمدة 30 دقيقة لمناقشة المتطلبات.'],['04','الاتفاق','نحدد النطاق والسعر والمدة قبل بدء التنفيذ.'],['05','الدفع والتنفيذ','بعد الاتفاق يتم الدفع الآمن عبر Stripe ثم يبدأ التطوير والاختبار.'],['06','التسليم والمتابعة','بعد التسليم تبقى المتابعة والتحديثات البريدية منظمة عبر Omnisend عند تفعيلها.']] : [['01','Idea','Define the goal and the result you want to achieve.'],['02','Project request','Submit the Tally form with project details, budget and supporting files.'],['03','Consultation','If needed, book a 30-minute Calendly consultation to discuss requirements.'],['04','Agreement','Confirm scope, price and timeline before development starts.'],['05','Payment & build','After agreement, payment is handled securely through Stripe and development begins.'],['06','Delivery & follow-up','After delivery, follow-up and email updates can be organized through Omnisend once activated.']];
